...
import {
  ...
  fetchPerformance, fetchSimilarTrades, fetchTrades, fetchTradeAnalysis, getTrade, simulateTrade,
  updateTrade, uploadTradeImage,
} from "./api";
...
function CoachStrip({ refreshKey, onOpenPerformance }) {
  ...
  return (
    <div className="coach">
      ...
      <div className="coach-foot">Generated by {model}{r.from_cache ? " · cached" : ""} · aggregated from trades you logged.</div>
    </div>
  );
}
